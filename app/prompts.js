	...
	return [
		{
			...
			name: 'dbUser',
			default: defaults.dbUser || 'mobidick',
			validate: requiredValidate
		}, {
			...
			name: 'themeDir',
			default: defaults.themeDir || 'MobidickTheme',
			validate: requiredValidate,
			when: function(res) {
			...
			name: 'themeUser',
			default: defaults.themeUser || 'agenciamobidick',
			validate: requiredValidate,
			when: function(res) {
			...
			name: 'themeRepo',
			default: defaults.themeRepo || 'MobidickTheme',
			validate: requiredValidate,
			when: function(res) {
				return !!res.installTheme && res.themeType == 'git';
			}
